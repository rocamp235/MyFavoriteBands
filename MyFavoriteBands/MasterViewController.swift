...
//********3) Add next two lines for array and title
        listArray = ["Pink Floyd", "Creedence Clearwater Revival","Gorillaz","Rainbow Kitten Surprise","Neon Indian", "Unknown Mortal Orchestra","Car Seat Headrest", "Wavves","Sugar Candy Mountain"]
